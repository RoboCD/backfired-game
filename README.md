...
Note: for macos, you will have to build the binary as a `.dylib` in a `pirate-game-jam-16.framework` folder. The framework folder should also have a `Resources` folder with a file called `Info.plist`. Without this file, signing will fail.
...
```sh
bin/pirate-game-jam-16.macos.template_debug.framework/pirate-game-jam-16.macos.template_release
bin/pirate-game-jam-16.ios.template_debug.framework/pirate-game-jam-16.ios.template_release.arm64.dylib
